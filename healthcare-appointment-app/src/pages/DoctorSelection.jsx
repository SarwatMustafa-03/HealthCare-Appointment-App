            ...
            <div id="selectedDoctor" className="mb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {selectedDoctor.map(doctor => (
                        <div
                            key={doctor.id}
                            className={`bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer ${selectedDoctor?.id === doctor.id ? 'ring-4 ring-purple-500' : ''
